    ...
    def mostrar_menu_habitacion(self):
       ...
       while bucle !=1:
             ...
             if eleccion == "1":
                ...
                capacidadMaxima = input("ingrese capacidad maxima ")
                tipoDeHabitacion = input("ingrese tipo de habitacion ")
                ...
                if len(habitaciones)>0:
                  for habitacion in habitaciones:            
                    print(f"ID: {habitacion[0]}, Número: {habitacion[1]}, Precio: {habitacion[2]}, Piso: {habitacion[3]}, Estado de Limpieza: {habitacion[4]}, Capacidad Actual: {habitacion[5]}, Capacidad Máxima: {habitacion[6]}, Tipo de Habitación: {habitacion[7]}")
                    print("\n")
                else:
